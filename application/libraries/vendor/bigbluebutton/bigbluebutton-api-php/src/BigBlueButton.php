...
class BigBlueButton
{
    ...
    {
        //$this->securitySecret   = 'AbfqKW9cTrZ4YEM80u71Tc4IznXwcgWnh0Q2whhHY';
        $this->securitySecret   = $_SESSION['bbb_secret'];

       // $this->bbbServerBaseUrl = 'https://sanalkonferans.gen.tr/bigbluebutton/';
        $this->bbbServerBaseUrl = $_SESSION['bbb_url'];
