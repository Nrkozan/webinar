    ...
    <div class="page-header-content">
        ...
        <div class="heading-elements">
            <div class="heading-btn-group">
                <button type="button" data-toggle="modal" data-target="#addmodal" class="btn btn-primary"><i class="icon-user-plus position-left"></i> Add New User</button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <table class="table datatable-basic table-xxs">
                            ...
                            <tbody>
                            <?php foreach ($this->main_model->getTable('user',['staff' => $this->session->userdata('id')]) as $row): ?>
                                <?php if ($row->level == 'staff' || $row->level == 'manag') ?>
                                <tr>
...
<div id="addmodal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content ">
            ...
            <form action="<?php echo base_url('user/add_manager_do')?>" method="post">
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Name</label>
